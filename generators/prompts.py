...
**필수 준수:**
- 한국 사이트만 포함 (.kr 도메인 우선)
- 해외 사이트는 절대 제외 (.com, .org 등 해외 도메인 금지)
- 한국어로 서비스되는 공식 사이트만 사용

**허용 도메인 예시:**
- 정부: .go.kr (홈택스, 정부24, 고용노동부 등)
- 공공기관: .or.kr (서민금융진흥원, 국민건강보험공단 등)
- 금융: .co.kr, .com (국내 은행, 보험사 한국 사이트)
- 뉴스: 국내 언론사 (조선일보, 중앙일보, 한경 등)

**금지 사항:**
- 미국/해외 정부 사이트 (예: california.gov 절대 금지)
- 영어로만 된 사이트
- 한국과 관련 없는 해외 서비스
...
1. 이 사이트가 한국어를 지원하는가?
2. 한국 사용자를 위한 서비스인가?
3. .kr 도메인인가? (아니라면 한국 서비스인지 재확인)

**예시 (좋은 예):**
- https://www.hometax.go.kr (홈택스)
- https://www.kinfa.or.kr (서민금융진흥원)
- https://www.knia.or.kr (손해보험협회)
- https://www.nps.or.kr (국민연금공단)

**예시 (나쁜 예 - 절대 금지):**
- https://www.insurance.ca.gov (캘리포니아 보험청)
- https://www.iii.org (미국 보험정보협회)
