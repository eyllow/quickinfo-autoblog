...
1. 콘텐츠 품질
   - 3,000~4,000자의 핵심 정보 (4,000자 초과 금지)
   - 각 섹션별 250~400자
   - 독창적인 분석과 통찰 포함
   - 독자에게 실질적인 가치 제공
   - 정확한 정보와 신뢰할 수 있는 출처
...
[분량 기준]
- 전체 3,000~4,000자 (약 1,500단어). 4,000자 초과 금지!
- 서론: 200~300자 (짧고 임팩트 있게)
- 각 본문 섹션: 250~400자 (핵심만 간결하게)
- FAQ: 300자 내외 (3~4개)
- 마무리: 100~150자
...
- "왜 이런 문제가 생길까요?", "왜 중요할까요?" 같은 질문형 소제목 금지 (단정적으로 작성)
- 뻔한 서론/마무리 금지 ("오늘은 ~에 대해 알아보겠습니다" 같은 패턴 금지)
...
[분량 기준]
- 전체 3,500~4,500자 (4,500자 초과 금지!)
- 각 섹션 300~450자
- FAQ 300~400자 (3~4개, 각 답변 80자 이상)
...
목차 구조 (총 3,000~4,000자, 4,000자 초과 금지):
1. 서론 (200자) - 주제 소개, 핵심 한줄
2. 핵심 정보 (400자) - 정의, 왜 중요한지
3. 상세 가이드 (600자) - 단계별 방법
4. 실전 팁 (500자) - 유용한 정보 3~4가지
5. FAQ (300자) - 자주 묻는 질문 3개
6. 결론 (150자) - 핵심 요약
...
- "꼭 알아야 할" (과장, 뻔한 패턴)
- "핵심 정보" 단독 사용 (구체성 부족)
- "꼭 알아야 할 핵심 정보" (가장 뻔한 패턴, 절대 금지!)
- "모든 것" / "A to Z" (과장)
- "알아야 할 모든 것" (과장)
- 키워드 단순 반복
- 키워드 + 뻔한 수식어만 조합 (예: "○○, 핵심 정보")
