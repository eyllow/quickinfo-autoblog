...
STRUCTURE_TEMPLATES = {
    ...
    "storytelling": {
        ...
        "sections": [
            {"type": "intro", "style": "story", "min_words": 300, "max_words": 450},
            {"type": "heading", "title": "처음 접했을 때의 어려움"},
            {"type": "content", "min_words": 450, "max_words": 650},
            {"type": "heading", "title": "알아두면 좋은 핵심 정보"},
            {"type": "content", "min_words": 600, "max_words": 850},
            {"type": "heading", "title": "단계별 실천 방법"},
            {"type": "list_content", "items": [5, 7], "min_words_per_item": 150},
            {"type": "heading", "title": "마무리"},
            {"type": "outro", "min_words": 250, "max_words": 400},
        ],
        "image_count": [2, 2],
        "total_words": [3500, 5000],
    },
    ...
    "listicle": {
        ...
        "sections": [
            {"type": "intro", "style": "hook", "min_words": 250, "max_words": 400},
            {"type": "heading", "title": "{keyword} 핵심 포인트"},
            {"type": "numbered_list", "items": [5, 8], "min_words_per_item": 200},
    ...
    "comparison": {
        ...
        "sections": [
            {"type": "intro", "style": "question", "min_words": 300, "max_words": 400},
            {"type": "heading", "title": "먼저 알아야 할 기본 정보"},
            {"type": "content", "min_words": 450, "max_words": 650},
            {"type": "heading", "title": "장점"},
            {"type": "list_content", "items": [4, 6], "min_words_per_item": 150},
            {"type": "heading", "title": "단점"},
            {"type": "list_content", "items": [3, 5], "min_words_per_item": 150},
    ...
    "qa_format": {
        ...
        "sections": [
            {"type": "intro", "style": "empathy", "min_words": 250, "max_words": 400},
            {"type": "heading", "title": "자주 묻는 질문"},
            {"type": "qa_list", "items": [6, 8], "min_words_per_item": 180},
